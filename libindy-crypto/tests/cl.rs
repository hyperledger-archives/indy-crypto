...
//        let master_secret = new_nonce().unwrap();
//
...
//        let (gvt_blinded_credential_secrets, gvt_credential_secret_blinding_factors, gvt_blinded_credential_secrets_correctness_proof) =
...
//                                             &credential_secret_blinding_factors,
//                                             &credential_pub_key,
//                                             &credential_issuance_nonce,
...
//        credential_schema_builder.add_attr("link_secret").unwrap();
...
//    }
//
//    pub fn gvt_credential_values(master_secret: &BigNumber) -> CredentialValues {
//        let mut credential_values_builder = Issuer::new_credential_values_builder().unwrap();
//        credential_values_builder.add_value("link_secret", &master_secret, new_nonce().unwrap());
...
//        credential_values_builder.add_dec_value("age", "28").unwrap();
//        credential_values_builder.add_dec_value("height", "175").unwrap();
//        credential_values_builder.finalize().unwrap()
//    }
//
//    pub fn xyz_credential_values(master_secret: &BigNumber) -> CredentialValues {
//        let mut credential_values_builder = Issuer::new_credential_values_builder().unwrap();
//        credential_values_builder.add_value("link_secret", &master_secret, new_nonce().unwrap()).unwrap();
//        credential_values_builder.add_dec_value("status", "51792877103171595686471452153480627530895").unwrap();
//        credential_values_builder.add_dec_value("period", "8").unwrap();
//        credential_values_builder.finalize().unwrap()
//    }
//
