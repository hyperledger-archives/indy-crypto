...
pub mod mocks {
    ...
    pub fn primary_credential() -> PrimaryCredentialSignature {
        PrimaryCredentialSignature {
            ...
            v: BigNumber::from_dec("").unwrap(),
        }
    }
