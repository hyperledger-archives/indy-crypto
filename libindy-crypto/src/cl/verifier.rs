...
//    }
    ...
    fn _verify_ge_predicate_works() {
        ...
        assert_eq!("43225984033774157453915588728969954740922016588061170767759883574388114107958905\
                    ...
                    403653903739045533820109066365142948601592388984410881602", res_data[0].to_dec().unwrap());

        assert_eq!("63167037026072942398294019215593337255694980292843024608055115132235566607178763\
                    ...
                    631410977703522487793355681154461192306192992914175461194", res_data[4].to_dec().unwrap());

        assert_eq!("15546471718851723564857886862663935179794166626786498408624620729765508845105285\
                    ...
                    453193009668829305398491649485593299490052238783007722867", res_data[5].to_dec().unwrap());
    }
}
